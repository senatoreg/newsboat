...
NB_DEPS=xlicense.h $(LIB_OUTPUT) $(FILTERLIB_OUTPUT) $(NEWSBOAT_OBJS) $(RSSPPLIB_OUTPUT) $(NEWSBOATLIB_OUTPUT) $(PLUGINS_OBJS)
...
$(PLUGINS): $(PLUGINS_OBJS)
	$(CXX) $(CXXFLAGS) -shared -o $@ $<  # $(NEWSBOAT_LIBS) $(LDFLAGS)
